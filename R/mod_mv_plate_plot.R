...
#         },
#         error = function(e) {
#           # Generate the grey ghost plate with the error message
#           err_plt <- e$message
#           return(err_plt)
#         }
#       )
...
#       req(res) 
#       # If res is a character -- thus the error msg
#       if (is.character(res)) {
#         # Generate the grey ghost plate using the error string
#         p <- render_ghost_plate_error(res, text_size = 12)
#         return(print(p))
#       }

#       # If res is a list as expected
#       plot_name <- grep(
...
#         p <- render_ghost_plate_error("Plate name mismatch", text_size = 12)
#         return(print(p))
#       }
