...
app_server <- function(input, output, session) {
  ...
  observeEvent(input$btn_variant_discovery, {
    session$sendCustomMessage(
      'open_link',
      list(
        url = 'https://awkena.github.io/panGenomeBreedr/articles/panGenomeBreedr_Workflows.html#variant-discovery'
      )
    )
  })
  ...
  observeEvent(input$btn_kasp_marker, {
    session$sendCustomMessage(
      'open_link',
      list(
        url = 'https://awkena.github.io/panGenomeBreedr/articles/panGenomeBreedr_Workflows.html#kasp-marker-design'
      )
    )
  })
  ...
  observeEvent(input$btn_marker_validation, {
    session$sendCustomMessage(
      'open_link',
      list(
        url = 'https://awkena.github.io/panGenomeBreedr/articles/panGenomeBreedr_Workflows.html#kasp-marker-validation'
      )
    )
  })
  ...
  observeEvent(input$btn_introgression, {
    session$sendCustomMessage(
      'open_link',
      list(
        url = 'https://awkena.github.io/panGenomeBreedr/articles/panGenomeBreedr_Workflows.html#decision-support-for-trait-introgression-and-mabc'
      )
    )
  })
        ...
        tagList(
          ...
          div(
            ...
            p(
              ...
              "Resets all data and reloads the current page."
            ),
            ...
            p(
              class = "text-muted small ms-2",
              "Closes the app and stops the R process."
            )
          ),
  ...
  # Call the database connection module server
  ...
  mod_ds_trait_introg_hypothesis_test_server(
