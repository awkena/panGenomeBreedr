...
<figure style="text-align: center;">
  <img src="figures/workflow.png" width="800" alt="panGenomeBreedr marker design workflow">
...
-   [UpSetR](https://cran.r-project.org/web/packages/UpSetR/index.html): Required for generating UpSet plots.
...
| `min_af`    | `numeric`   | Minimum allele frequency. |
| `max_af`    | `numeric`   | Maximum allele frequency. |
| `chrom`     | `character` | Chromosome name. |
| `start`     | `numeric`   | Start coordinate of the region. |
| `end`       | `numeric`   | End coordinate of the region. |
