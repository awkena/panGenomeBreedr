...
`panGB` depends on a list of Bioconductor packages that may not installed automatically alongside `panGB`. To manually install these packages, use the code snippet below:
...
library(knitr)
knitr::kable(geno[1:5, 1:10], caption = 'Table 1: Example vcf file containing identified variants.', format = 'html')
...
```{r, echo = FALSE}
library(knitr)
knitr::kable(ma1, caption = 'Table 2: Intertek required sequence for a designed KASP marker.', format = 'html')
...
```{r, echo = FALSE}
library(knitr)
knitr::kable(my_sum$summ, caption = 'Table 3: Summary of verified prediction status for samples in plates', format = 'html')
