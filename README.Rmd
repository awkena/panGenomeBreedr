...
In its current development version, `panGB` provides customizable functions for KASP marker QC visualization to test hypotheses on marker validation and effectiveness. `panGB` will host a user-friendly shiny application to enable non-R users to access its functionalities outside R. Capabilities for KASP marker design will be added soon.
