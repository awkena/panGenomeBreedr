...
To visualize predictions for positive controls to validate KASP markers, the column name containing expected genotype calls must be provided and passed to the function using the `Group_id = 'Group'` argument as shown in the code snippet above. If this information is not available, set the argument `Group_id = NULL`.  
...
```{r plate_12_design, fig.cap = "Fig. 2. Observed genotype calls for samples in Plate 12 in a plate design format."}
